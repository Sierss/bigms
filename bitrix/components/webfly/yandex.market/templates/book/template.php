        ...
        if ((($arResult["WF_CURR"] - $arParams["BIG_CATALOG_PROP"]) < $arResult["WF_FULL"]))
        {
            if ($arResult["WF_CURR"] < $arResult["WF_FULL"])
            {
                if ($arResult["WF_NUM"] == 1)
                {
                    ...
                    $savedXML .= '<offers>';
                    foreach ($arResult["OFFER"] as $arOffer):
                        $savedXML .= '<offer type="book" id="' . $arOffer["ID"] . '" available="' . $arOffer["AVAIBLE"] . '">';
                        ...
                        if ($arOffer["DISPLAY_PROPERTIES"][$arParams["SERIES"]]["DISPLAY_VALUE"]):
                            $savedXML .= '<series>' . $arOffer["DISPLAY_PROPERTIES"][$arParams["SERIES"]]["DISPLAY_VALUE"] . '</series>';
                        endif;
                        ...
                        if ($arOffer["DISPLAY_PROPERTIES"][$arParams["VOLUME"]]["DISPLAY_VALUE"]):
                            $savedXML .= '<volume>' . $arOffer["DISPLAY_PROPERTIES"][$arParams["VOLUME"]]["DISPLAY_VALUE"] . '</volume>';
                        endif;
                        if ($arOffer["DISPLAY_PROPERTIES"][$arParams["PART"]]["DISPLAY_VALUE"]):
                            $savedXML .= '<part>' . $arOffer["DISPLAY_PROPERTIES"][$arParams["PART"]]["DISPLAY_VALUE"] . '</part>';
                        endif;
                        if ($arOffer["DISPLAY_PROPERTIES"][$arParams["BINDING"]]["DISPLAY_VALUE"]):
                            $savedXML .= '<binding>' . $arOffer["DISPLAY_PROPERTIES"][$arParams["BINDING"]]["DISPLAY_VALUE"] . '</binding>';
                        endif;
                        if ($arOffer["DISPLAY_PROPERTIES"][$arParams["PAGE_EXTENT"]]["DISPLAY_VALUE"]):
                            $savedXML .= '<page_extent>' . $arOffer["DISPLAY_PROPERTIES"][$arParams["PAGE_EXTENT"]]["DISPLAY_VALUE"] . '</page_extent>';
                        endif;
                        if (!empty($arOffer["DESCRIPTION"]) or ! empty($arOffer["DOP_PROPS"])):
