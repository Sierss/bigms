...
if($this->StartResultCache(false, array($arrFilter, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()), $arNavigation, $pagerParameters)))
{
	...
	//echo '<pre>' . print_r($rsElements, true) . '</pre>';
    ...
    //$arResult['~COMPARE_URL_TEMPLATE'] = '/catalog/#CAT#/compare/?'.$arParams["ACTION_VARIABLE"]."=ADD_TO_COMPARE_LIST&".$arParams["PRODUCT_ID_VARIABLE"]."=#ID#";
