        ...
        <shop>
            ...
            <offers>
                <? foreach ($arResult["OFFER"] as $arOffer): ?>
                    <offer type="event-ticket" id="<?= $arOffer["ID"] ?>" available="<?= $arOffer["AVAIBLE"] ?>">
                        <url><?= $arOffer["URL"] ?></url>
                        ...
                        <? if ($arOffer["DISPLAY_PROPERTIES"][$arParams["PLACE"]]["DISPLAY_VALUE"]): ?><place><?= $arOffer["DISPLAY_PROPERTIES"][$arParams["PLACE"]]["DISPLAY_VALUE"] ?></place><? endif ?>				
                        <? if ($arOffer["DISPLAY_PROPERTIES"][$arParams["DATE"]]["DISPLAY_VALUE"]): ?><date><?= $arOffer["DISPLAY_PROPERTIES"][$arParams["DATE"]]["DISPLAY_VALUE"] ?></date><? endif ?>								
                        <? if ($arOffer["DISPLAY_PROPERTIES"][$arParams["IS_PREMIERE"]]["DISPLAY_VALUE"]): ?><is_premiere><?= $arOffer["DISPLAY_PROPERTIES"][$arParams["IS_PREMIERE"]]["DISPLAY_VALUE"] ?></is_premiere><? endif ?>								
                        <? if ($arOffer["DISPLAY_PROPERTIES"][$arParams["IS_KIDS"]]["DISPLAY_VALUE"]): ?><is_kids><?= $arOffer["DISPLAY_PROPERTIES"][$arParams["IS_KIDS"]]["DISPLAY_VALUE"] ?></is_kids><? endif ?>								
        ...
        if ((($arResult["WF_CURR"] - $arParams["BIG_CATALOG_PROP"]) < $arResult["WF_FULL"]))
        {
            if ($arResult["WF_CURR"] < $arResult["WF_FULL"])
            {
                if ($arResult["WF_NUM"] == 1)
                {
                    ...
                    $savedXML .= '<offers>';
                    foreach ($arResult["OFFER"] as $arOffer):
                        $savedXML .= '<offer type="event-ticket" id="' . $arOffer["ID"] . '" available="' . $arOffer["AVAIBLE"] . '">';
                        ...
                        if ($arOffer["DISPLAY_PROPERTIES"][$arParams["PLACE"]]["DISPLAY_VALUE"]):
                            $savedXML .= '<place>' . $arOffer["DISPLAY_PROPERTIES"][$arParams["PLACE"]]["DISPLAY_VALUE"] . '</place>';
                        endif;
                        if ($arOffer["DISPLAY_PROPERTIES"][$arParams["DATE"]]["DISPLAY_VALUE"]):
                            $savedXML .= '<date>' . $arOffer["DISPLAY_PROPERTIES"][$arParams["DATE"]]["DISPLAY_VALUE"] . '</date>';
                        endif;
                        if ($arOffer["DISPLAY_PROPERTIES"][$arParams["IS_PREMIERE"]]["DISPLAY_VALUE"]):
                            $savedXML .= '<is_premiere>' . $arOffer["DISPLAY_PROPERTIES"][$arParams["IS_PREMIERE"]]["DISPLAY_VALUE"] . '</is_premiere>';
                        endif;
                        if ($arOffer["DISPLAY_PROPERTIES"][$arParams["IS_KIDS"]]["DISPLAY_VALUE"]):
                            $savedXML .= '<is_kids>' . $arOffer["DISPLAY_PROPERTIES"][$arParams["IS_KIDS"]]["DISPLAY_VALUE"] . '</is_kids>';
                        endif;
                        if (!empty($arOffer["DESCRIPTION"]) or ! empty($arOffer["DOP_PROPS"])):
